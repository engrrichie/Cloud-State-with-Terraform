resource "aws_elastic_beanstalk_environment" "vprofile-bean-prod25" {
  name                = "vprofile-bean-prod25"
  application         = aws_elastic_beanstalk_application.vprofile-prod.name
  solution_stack_name = "64bit Amazon Linux 2 v4.3.9 running Tomcat 8.5 Correto 11"
  cname_prefix        = "vprofile-bean-prod25-domain"
  setting {
    name      = "VPCId"
